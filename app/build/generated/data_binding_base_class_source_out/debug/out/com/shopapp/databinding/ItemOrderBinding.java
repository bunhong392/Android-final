...
public final class ItemOrderBinding implements ViewBinding {
  ...
  private ItemOrderBinding(@NonNull CardView rootView, @NonNull TextView tvAddress,
      ...
      @NonNull TextView tvPayment, @NonNull TextView tvStatus, @NonNull TextView tvTotal) {
  ...
  public static ItemOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderBinding((CardView) rootView, tvAddress, tvDate, tvItems, tvOrderId,
          tvPayment, tvStatus, tvTotal);
    }
